...
function drawNetwork() {
	...
	var marker = networkChart.vis.append("defs").selectAll("marker")
		    .data(networkChart.force.nodes())
		  .enter().append("marker")
		    .attr("id", function(d) { return "mark"+d.id; })
		    .attr("viewBox", "0 -5 10 10")
		    .attr("refX",function(d) { return d.size+11; })
		    .attr("refY", -1.5)
		    .attr("markerWidth", 10)
	...
	.attr("marker-end",function(d) { return "url(#mark" + d.target.id + ")";});
	...
	.attr("marker-end",function(d) { return "url(#" + d.target.label + ")";});
...
function drawChord() {
	...
	.style("font-size", function(d) { return 20>9+100*(d.endAngle-d.startAngle)?9+100*(d.endAngle-d.startAngle):20; })
