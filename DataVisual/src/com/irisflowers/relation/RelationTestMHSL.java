...
//		}
		...
		datemap.put("308-312", 0);
		datemap.put("313-317", 1);
		datemap.put("318-322", 2);
		datemap.put("323-327", 3);
		datemap.put("328-401", 4);
		datemap.put("402-406", 5);
		datemap.put("407-411", 6);
		datemap.put("412-416", 7);
		...
		try {
			...
			for(int i = 0; i < evolist.getLength(); i++) {
				...
				size1 = Double.parseDouble(topic1.getAttribute("topicweight"))*300;
				label1 = topic1.getAttribute("year") + ": " + tag1;
				color1 = yearkeys[datemap.get(topic1.getAttribute("year"))];
				...
				size2 = Double.parseDouble(topic2.getAttribute("topicweight"))*300;
				label2 = topic2.getAttribute("year") + ": " + tag2;
				color2 = yearkeys[datemap.get(topic2.getAttribute("year"))];
