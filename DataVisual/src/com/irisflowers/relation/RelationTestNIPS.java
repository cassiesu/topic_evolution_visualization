...
//		}
		...
		try {
			...
			for(int i = 0; i < evolist.getLength(); i++) {
				...
				tag1 = "";			//每次循环后必须清空
				str1 = "";
				tag1 = ws[0]+" "+ws[1]+" "+ws[2]+" "+ws[3]+" "+ws[4]+" ";
				str1 = ws[0]+" "+ws[1]+" "+ws[2]+" "+ws[3]+" "+ws[4]+" "+ws[5]+" "+ws[6]+" "+ws[7]+" "+ws[8]+" "+ws[9];
				
				size1 = Double.parseDouble(topic1.getAttribute("topicweight"))*800;
				label1 = topic1.getAttribute("year") + ": " + tag1;
				color1 = yearkeys[Integer.parseInt(topic1.getAttribute("year"))-2003];
				...
				tag2 = "";			//每次循环后必须清空
				str2 = "";
				tag2 = ws[0]+" "+ws[1]+" "+ws[2]+" "+ws[3]+" "+ws[4]+" ";
				str2 = ws[0]+" "+ws[1]+" "+ws[2]+" "+ws[3]+" "+ws[4]+" "+ws[5]+" "+ws[6]+" "+ws[7]+" "+ws[8]+" "+ws[9];
				
				size2 = Double.parseDouble(topic2.getAttribute("topicweight"))*800;
				label2 = topic2.getAttribute("year") + ": " + tag2;
				color2 = yearkeys[Integer.parseInt(topic2.getAttribute("year"))-2003];
